...
class UnitProfilesWidget extends ContentWidget
{
    public function init()
    {
        parent::init();
        $id = __CLASS__.$this->params['content']->id;
        $this->params['profileVar'] = $this->params['content']->urlParam('view');
        $blank = true;
    ...
    protected function prepareTable()
    {
        ...
        $dataProvider=new CActiveDataProvider('User', array(
            'pagination'=>CMap::mergeArray(array(
                'pageVar'=>$this->params['content']->urlParam('page'),
            ...
            'sort'=>CMap::mergeArray(array(
                'sortVar'=>$this->params['content']->urlParam('sort'),
            ), $urlparams),
        ));
        $tableFields[] = array(
            'class'=>'CButtonColumn',
