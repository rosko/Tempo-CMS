...
//    'Title' => 'Заголовок',
    ...
    'Please save before using it.' => 'Пожалуйста, сохраните перед тем, как использовать.',
    'Hide filemanager' => 'Скрыть файлменеджер',
    'Select file' => 'Выбрать файл',
    'Click twice on file to select.' => 'Для выбора файла щелкните нам нем дважды.',

    '{n} byte|{n} bytes' => '{n} байт|{n} байта|{n} байт|{n} байта',
    '{n} KB|{n} KB' => '{n} килобайт|{n} килобайта|{n} килобайт|{n} килобайта',
    '{n} MB|{n} MB' => '{n} мегабайт|{n} мегабайта|{n} мегабайт|{n} мегабайта',
    '{n} GB|{n} GB' => '{n} гигабайт|{n} гигабайта|{n} гигабайт|{n} гигабайта',
    '{n} TB|{n} TB' => '{n} терабайт|{n} терабайта|{n} терабайт|{n} байта',
    ...
    'Show page on error 404 (page not found)' => 'Отображать следующую страницу при ошибке 404 (страница не найдена)',
    'Show page on error 403 (access denied)' => 'Отображать следующую страницу при ошибке 403 (доступ запрещен)',
